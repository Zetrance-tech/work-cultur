...
//create deparment wihtout transaction
// Create Department
export const createDepartment = asyncHandler(async (req: Request, res: Response) => {
  ...
  // Check if organization exists and belongs to admin
  ...
  // Push department ID to organization
  ...
  if (!organizationDetails) {
    throw new ApiError(500, 'Failed to update organization with new department');
  }
  ...
  return new ApiResponse(201, newDepartment, "Department created successfully").send(res);
});
